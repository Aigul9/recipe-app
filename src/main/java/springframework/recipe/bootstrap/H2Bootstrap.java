package springframework.recipe.bootstrap;
...
@Slf4j
@Component
@Profile("default") // when nothing else is set
public class H2Bootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public H2Bootstrap(CategoryRepository categoryRepository,
    ...
    private List<Recipe> getRecipes() {
        ...
        guacamoleRecipe.addIngredient(new Ingredient("ripe avocados", new BigDecimal(2), eachUom))
                ...
                .addIngredient(new Ingredient("serrano chillis, stems and seeds removed, minced", new BigDecimal(2), eachUom))
        ...
        tacoNotes.setRecipeNotes("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
                "Any and every kind of leftover can go inside a warm tortilla, usually with a healthy dose of pickled jalapenos. The aroma of tortillas heating in a hot pan on the stove comes wafting through the house.\n" +
